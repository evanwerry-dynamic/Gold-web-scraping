...
export function PnLHeader() {
  ...
  return (
    ...
    >
      {/* Main P&L */}
      <div>
        <span style={{ color: "#999", fontSize: 10, marginRight: 6 }}>TOTAL P&L</span>
        <span
          style={{
            fontSize: 28,
            fontWeight: 700,
      ...
      {/* Today */}
      <div>
        <span style={{ color: "#999", fontSize: 10, marginRight: 4 }}>TODAY</span>
      ...
      {/* Bankroll */}
      <div>
        <span style={{ color: "#999", fontSize: 10, marginRight: 4 }}>BANKROLL</span>
      ...
      {/* Drawdown */}
      <div>
        <span style={{ color: "#999", fontSize: 10, marginRight: 4 }}>DD</span>
