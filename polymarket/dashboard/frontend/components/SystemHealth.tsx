...
export function SystemHealth() {
  ...
  return (
    <div style={{ padding: 12, borderLeft: "1px solid #1e1e1e", fontSize: 11 }}>
      <div style={{ color: "#555", marginBottom: 8, fontSize: 10, letterSpacing: 1 }}>
        SYSTEM HEALTH
      </div>
      <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
        ...
        <div style={{ marginTop: 8, color: "#555", fontSize: 10 }}>BTC PRICE</div>
        <div style={{ color: "#00ff88", fontSize: 16, fontWeight: 700 }}>
          ${h.btc_price.toLocaleString("en-US")}
        </div>
        <div style={{ marginTop: 4, color: "#555", fontSize: 10 }}>OPEN POSITIONS</div>
